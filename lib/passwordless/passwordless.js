...
//user is the user object
 Passwordless.prototype.requestTokenDirectly = function(getUserID, toAddress, delivery, options) {
	var self = this;
	options = options || {};
					...
					if(storeError) {
						...
						deliveryMethod.sendToken(token, uid, user, req, function(deliveryError) {
							if(deliveryError) {
								...
								console.log('[DIRECT] Not calling next here does this lead to a bug when creating emails?')
								// next();
							}
						})		
					}	
